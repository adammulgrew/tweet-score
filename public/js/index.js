...
/******/ 	var hotCurrentHash = "9385e72ab29ce571477c"; // eslint-disable-line no-unused-vars
...
var onDOMContentLoadedTasks = [function () {
	if (!document.querySelector(_constants2.default.SEARCH.SELECTOR.INPUT)) return;

	[].slice.call(document.querySelectorAll(_constants2.default.SEARCH.SELECTOR.INPUT)).forEach(function (el) {
		el.addEventListener('submit', function (e) {
			window.setTimeout(function () {
				document.querySelector(_constants2.default.SEARCH.SELECTOR.BODY).innerHTML = '<div class="is--searching"><img src="/img/loading-balls.gif"></div>';
			}, 10);
		});
	});
}];
